...
object EdukasiData {
    ...
    fun getKategori(): List<EdukasiKategoriEntity> {

        return listOf(
            EdukasiKategoriEntity(
                "1",
    ...
    fun getSebelumGempaTerjadi(): List<EdukasiPilihanEntity> {
        return listOf(
            EdukasiPilihanEntity(
                "1",
    ...
    fun getSaatGempaTerjadi(): List<EdukasiPilihanEntity> {
    ...
    fun getSetelahGempaTerjadi(): List<EdukasiPilihanEntity> {
        return listOf(
            EdukasiPilihanEntity(
                "1",
                "A. Jika Anda berada di dalam bangunan",
